# -*- coding: utf-8 -*-
"""
This script is adapted from the RemoteSensing-of-River-Ice tutorial (https://github.com/SdeRodaHusman/remotesensing-of-river-ice/blob/main/README.md) by SdeRodaHusman (contact: S.deRodaHusman@tudelft.nl).
...
os.getcwd()  #not needed in final code
#%% 
...
#%%
# Reformat VH    
VH = read_nc.variables['Gamma0_VV_db'][:]
...
#%%
#Dont need due if using dB bands
'''
...
# Reformat polarimetric features
...
df_final.to_csv(output_path +'\FeatureMatrix_SARimage.csv', index = False, header=True)   
